...
namespace podberi_pary
{
    public partial class Form1 : Form
    {
        ...
        // that the player clicks, but it will be null     // if the player hasn't clicked a label yet
        ...
        private void AssignIconsToSquares()
        {
            ...
            foreach (Control control in tableLayoutPanel1.Controls)
            {
                Label iconLabel = control as Label; if (iconLabel != null)
                {
                    int randomNumber = random.Next(icons.Count); iconLabel.Text = icons[randomNumber];
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            timer1.Stop();
            // Hide both icons
            firstClicked.ForeColor = firstClicked.BackColor; secondClicked.ForeColor = secondClicked.BackColor;
